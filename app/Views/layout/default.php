    ...
    <div class="main-wrapper">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
            <div class="sidebar-brand">
                <a href="<?=site_url()?>">E-Wedding</a>
            </div>
            <div class="sidebar-brand sidebar-brand-sm">
                <a href="<?=site_url()?>">E-Wed</a>
            </div>
            ...
            <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                <a href="" class="btn btn-primary btn-sm btn-block btn-icon-split">
                    <i class="fas fa-rocket"></i> Get to Pro
                </a>
            </div>
        </aside>
      </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2023 <div class="bullet"></div> Developed By <a href="">Zenlie</a>
        </div>
